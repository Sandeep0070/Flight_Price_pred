...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            numerical_cols = ['Total_Stops', 'Day', 'Month', 'Year', 'Dept_Hour', 'Dept_Min','Arrival_hour', 'Arrival_min', 'duration_hour', 'duration_min']
            ...
            additional_categories = ['No info', 'In-flight meal not included',
                                    'No check-in baggage included', '1 Short layover', 'No Info','1 Long layover', 'Change airports', 'Business class','Red-eye flight', '2 Long layover']
    ...
    def initaite_data_transformation(self,train_path,test_path):
        try:
            ...
            drop_columns = [target_column_name,'Route']
